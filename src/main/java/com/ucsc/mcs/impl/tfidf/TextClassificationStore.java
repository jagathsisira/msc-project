...
//        logger.info("TFIDF Word Master:  " + wordMaster.toString());
    ...
    public List<String> generateWordMasterFromFile(){
        List<String> wordMaster = new ArrayList<>();
        try
        {
            String data = new String(Files.readAllBytes(Paths.get("wordMaster.txt")));
        ...
        logger.info("Word master generated with size : " + wordMaster.size());
        return wordMaster;
    }
